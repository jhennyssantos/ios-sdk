...
@objc public class TerminalListManager: NSObject {
    ...
    var terminalListener: TerminalListManagerProtocol?

    public static let shared = TerminalListManager()
    ...
    public func setTerminalListener(listener: TerminalListManagerProtocol) {
    ...
    public func startTerminalsDiscovery() {
        ...
        if self.getAccessoryList().count == 1 {
            TerminalListManager.shared.registerCurrentAccessory(accessory: self.getAccessoryList()[0])
